...
DEFECTS = {
    0: {
        0: {0: [0.1397180648621, 0.02783573718, 0.0167922941, -0.001459031, 0.002922765]},
        1: {1: [0.2966564877175, 0.03829666659, 0.007513112, -0.004547679, 0.00218014]}
    },
    1: {
        0: {
    ...
    2: {
        0: {
            1: [0.00211337846449, -0.003090051058, 0.0000082722, -0.000309431, -0.00040114]},
        1: {
...
class MatrixFsH0(MatrixFs):
    def generate_matrix(self):
        ...
        for i, state in enumerate(self.states):
            n, l, s, j, m = state
            matrix[i,i] = quantumdefect_fs.qd.energylevel(n, l, s, j)
        return matrix
